...
def mpc(model):
    ...
    mterm = - model.x['p_y_1']
    lterm = if_else(model.x['s']==1, - model.x['p_y_1'] , model.x['p_y_1'] ) - model.x['p_y_3'] + if_else(model.x['s']==2, model.x['p_y_2'], - model.x['p_y_2'] )  + if_else(model.x['s']==3, - model.x['v_x_1'], model.x['v_x_1']**2)
